...
// renderIndexFrontmatter emits the bundle-root index frontmatter block,
// including okf_version when the marker-compatibility contract says it should be
// present (see bundleRootOkfVersion). The value is quoted so the marker is an
// unambiguous YAML string regardless of how it was originally declared.
